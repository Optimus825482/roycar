...
const DEFAULT_PROMPTS: Record<string, string> = {
  chat_system_prompt: `Sen Merit Royal Hotels İK asistanısın. Adın Merit AI.
...
Konuşma özeti varsa, önceki konuşma bağlamını sürdür.`,
  ...
  screening_system_prompt: `Sen Merit Royal Hotels'in ön eleme uzmanısın.
