...
UPDATE "admin_users" SET "permissions" = '{"form_builder":true,"ai_chat":true,"evaluations":true,"screening":true,"data_import":true,"settings":true,"user_management":true}' WHERE "email" = 'admin@fbcareersystem.com';
